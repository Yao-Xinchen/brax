...
def compute_ts_loss(
    params: TSNetworkParams,
    normalizer_params: Any,
    data: types.Transition,
    rng: jnp.ndarray,
    ts_network: ts_networks.TSNetworks,
  ...
  """
  parametric_action_distribution = ts_network.parametric_action_distribution
  policy_apply = ts_network.policy_network.apply
  value_apply = ts_network.value_network.apply
