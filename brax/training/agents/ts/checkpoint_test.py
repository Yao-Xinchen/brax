...
class CheckpointTest(absltest.TestCase):
  ...
  def test_ts_params_config(self):
  ...
  def test_save_and_load_checkpoint(self):
    ...
    network_params = ts_losses.TSNetworkParams(
        policy=ts_network.policy_network.init(dummy_key),
        value=ts_network.value_network.init(dummy_key),
    )
