...
def train(
        ...
        apg_stop_env_step: Optional[int] = None,
):
    """PPO training.
    ...
    if apg_update_frequency > 0:
        ...
        apg_loss_fn_jit = jax.jit(apg_loss_fn)
    ...
    training_epoch_pmap = jax.pmap(training_epoch,
                                   axis_name=_PMAP_AXIS_NAME)  ## HYBRID PPO/APG: Renamed to avoid collision
    ...
    def training_epoch_with_timing(
        ...
        result = training_epoch_pmap(
            (training_state, env_state, key, step_count))  ## HYBRID PPO/APG: Pass tuple to pmapped func
